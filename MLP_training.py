...
def train(model,train_dataloader, val_dataloader, optimizer, loss_fn, total_epochs, lr=0.01, patience=3):
...
# breakpoint()
    ...
    train(model,train_dataloader, val_dataloader, optimizer, loss_fn, total_epochs)
